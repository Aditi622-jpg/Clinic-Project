...
This version is cleaner, fixes grammar and formatting, removes repetition, and follows the style commonly seen in professional GitHub repositories. One more improvement I strongly recommend is adding screenshots of your home page, booking page, admin dashboard, chart, and PDF report—those make a repository much more attractive to recruiters and professors.
